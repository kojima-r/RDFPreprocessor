...
if __name__ == "__main__":
    #filename="data01/expressionatlas/latest/E-MTAB-2706.ttl"
    #filename="data01/biosample/latest/bioschemas.ttl"
    filelist=["data01/expressionatlas/latest/E-MTAB-2770.ttl",
    ...
    for filename in filelist:
        ...
        """
        data=[]
        for filename in glob.glob("data01/**/*.fix_ttl",recursive=True):
            path=os.path.dirname(filename)
            name=os.path.basename(filename)
            filename = path+"/"+name
            name_, _ =os.path.splitext(name)
